...
def calculate_energy(mol: Chem.Mol, forcefield: str = "UFF", add_hs: bool = True) -> float:
    """
...
def relax_constrained(mol: Chem.Mol, forcefield: str = "UFF", add_hs: bool = True, maxDispl=0.1) -> float:
    """
